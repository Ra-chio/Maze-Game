 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(55,160,"NMAM INSTITUTE OF TECHNOLOGY");
	glColor3f(1,1,1);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"Rachana Shetty");

	output(40,80,"4nm18cs123");
	glColor3f(1,0,1);
	output(40,60,"Submitted to");
	glBegin(GL_LINES);
	glVertex2f(40,58);
	glVertex2f(98,58);
	glEnd();
	...
	output(40,50,"");
	glColor3f(1,0,0);
	output(40,50,"Puneeth R P");
	glColor3f(1,0,0);
	output(40,40,"Lecturer,Dept. of CSE");
	glFlush();
